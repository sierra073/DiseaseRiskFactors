FigB2=function(){
  ...
  png('plot2m.png',width=600,height=420)  
  
  mage <-mean(AGE[!is.na(HTC) & !is.na(ALL_UKB)])
  
  #initial plot dimensions setup
  plot(HTC,YY_QUART,type='n',axes=F,cex=1.0,labels=c(48,11,3),xlim=c(1,48),xlab='',ylim=c(0,53),ylab='')
  ...
  #left y-axis
  axis(side=2, at=c(0,10,20,30,40,50),labels=c(0,10,20,30,40,50),las=2, cex.axis=0.8)
  mtext('% Hypercholesterolemia  (age-adjusted)',side=2,line=2.5)
  
  #right y-axis
  axis(side=4, at=c(0,10,20,30,40,50),labels=c(0,10,20,30,40,50),las=2, cex.axis=0.8)
  
  #set up title
  box()
  mtext('HYPERCHOLESTEROLEMIA PREVALENCE 1993-2004 : GENEVA MEN (35-74 yrs)',side=3,line=1,cex.axis=1.0)
